...
class InputsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create input" do
    assert_difference('Input.count') do
      post inputs_url, params: { input: { image_url: @input.image_url, is_direction: @input.is_direction, name: @input.name } }
    end
  ...
  test "should update input" do
    patch input_url(@input), params: { input: { image_url: @input.image_url, is_direction: @input.is_direction, name: @input.name } }
